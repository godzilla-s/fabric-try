...
public class SimpleChaincode extends ChaincodeBase {
    ...
    private Response invoke(ChaincodeStub stub, List<String> args) throws Exception {
        if (args.size() != 3) {
    ...
    private Response query(ChaincodeStub stub, List<String> args) throws Exception {
        if (args.size() != 1) {
